...
PROFILE_URI_IEEE_SCD = "https://opensource.ieee.org/scd/scd/-/blob/main/resources/context.jsonld"
...
async def translate_case(
    ...
    - Accept: application/ld+json; profile="https://opensource.ieee.org/scd/scd/-/blob/main/resources/context.jsonld" for IEEE SCD
